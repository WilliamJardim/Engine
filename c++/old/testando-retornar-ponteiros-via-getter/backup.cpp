...
int main() {
    ...
    ObjetoBase* objeto1  = new Objeto("Objeto 1");
    ObjetoBase* objeto2  = new Objeto("Objeto 2");
    ObjetoBase* objeto3  = new Objeto("Objeto 3");
    ObjetoBase* carro    = new Carro("O CARRO", "Chao");
