        ...
        if( (this.objProps.traverse != true) &&
            ...
            */
            if( this.isFalling === true )
            {
                ...
                */
                if( this.objProps.name != 'PlayerBody' && this.objProps.name != 'Player' && this.objProps.name != 'PlayerCamera' && this.objProps.name != 'Camera' ){
            ...
            // Se o objeto não está caindo
                ...
                if( this.objectBelow != null && this.objProps.name != 'Player' && this.objProps.name != 'PlayerBody' && this.objProps.name != 'PlayerCamera' && this.objProps.name != 'Camera' ){
